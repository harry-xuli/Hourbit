...
| 检查 | 当前状态 | 最终证据 |
|---|---|---|
| v0.7.0 完整 Release 基线 | 通过 | App 288 + Core 259 + Infrastructure 143 + Windows 97 = 787/787 |
| v0.7.1 B 方案品牌回归 | 通过 | 主图、ICO 与真实 32px 托盘图标 3/3 |
| v0.7.1 GitHub Actions 完整 Release | 通过 | App 289 + Core 259 + Infrastructure 143 + Windows 97 = 788/788 |
| v0.7.1 非 WPF 分层回归 | 通过 | Core 259 + Infrastructure 143 + Windows 97 = 499/499 |
...
| Setup/ZIP 文件名与版本一致 | 通过 | Hourbit / 0.7.1 / 2026-08-22 |
| SHA-256 sidecar | 通过 | 与两个实际文件逐字节核对一致 |
| Authenticode | 通过 | Setup 与 Portable 内 Hourbit.exe 均为 `CN=Harry`，指纹一致并含 DigiCert 时间戳 |
| GitHub Release v0.7.1 | 通过 | [公开发布页](https://github.com/harry-xuli/Hourbit/releases/tag/v0.7.1)；四个正式附件名、大小和 digest 已读回核对 |
