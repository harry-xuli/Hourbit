...
public sealed class TimelineViewTests
{
    ...
    {
        public Task<IReadOnlyList<Hourbit.Core.Search.ItemSearchResult>> SearchAsync(
            Hourbit.Core.Search.ItemSearchFilter filter, CancellationToken ct) =>
            Task.FromResult<IReadOnlyList<Hourbit.Core.Search.ItemSearchResult>>([]);
    }
